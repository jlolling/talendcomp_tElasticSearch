...
public final class Base64 {
     ...
     */
    public static byte[] encode(byte[] binaryData, int length) {
     ...
     * @param breakLines true=Zeilenumbruch einbauen
    ...
    /**
     * write base64 array in a writer, without memory consumtion
     * @param base64Data
    ...
    public static byte[] toBase64Binary(String base64String) {
        // Anzahl der auszuwertenden Zeichen im String zählen
    ...
    public static String getText(String base64EncodedString) throws UnsupportedEncodingException {
        return getText(base64EncodedString, DEFAULT_CHARSET);
    }

    public static String getText(String base64EncodedString, String charset) throws UnsupportedEncodingException {
        return new String(decode(toBase64Binary(base64EncodedString)), charset);
    }

    /**
     * creates a in BASE64 coded String from original byte data
    ...
    /**
     * retrievs the original data from in BASE64 coded String
     * @param base64String String contains in BASE64 coded data
     * @return byte arry with raw data
     */
